...
<template>
  <h1 class="has-text-centered has-text-light is-size-1 is-size-3-mobile pt-6">
    Welcome to my creative lab
  </h1>
  <h2 class="is-size-4 is-size-5-mobile has-text-centered py-4 has-text-light">Currently <span class="has-text-success">
    {{ demoCount }}
  </span>
   demos</h2>
  <h3 class="is-size-4 is-size-5-mobile has-text-centered py-4 max_subtitle_size has-text-light">
  ...
  <div>
    <NavBar @searchResult="(value) => updateSearch(value)" />
    <!-- BODY -->
