...
import TheExperience from '@/components/demos/a-c/CustomCarousel.vue'
...
<template>
  <div class="has-text-centered mb-4 z-index-10">
    <button class="button is-light mx-4" @click="activeCS = (activeCS + 1) % URLS.length">
      Prev
    </button>
    <button class="button is-light" @click="activeCS = (activeCS - 1 + URLS.length) % URLS.length">
      Next
    </button>
  </div>
