...
import {
  Color, BasicShadowMap,
  SRGBColorSpace,
  NoToneMapping,
  AdditiveBlending
} from 'three'
import fragment from '@/components/shaders/ParticlesRing/fragment.glsl'
import vertex from '@/components/shaders/ParticlesRing/vertex.glsl'
