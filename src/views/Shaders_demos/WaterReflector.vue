...
const customShader = ThreeReflector.ReflectorShader

customShader.vertexShader = vertex
customShader.fragmentShader = fragment
customShader.uniforms.tDudv = { value: map }
...
<template>
  <TresCanvas window-size clear-color="#111" ref="canvasRef">
    ...
    <Reflector ref="mirrorRef" :shader="customShader" :rotation="[-Math.PI * 0.5, 0, 0]" :position="[0, -2, 0]" color="#222">
