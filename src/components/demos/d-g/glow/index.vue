...
<template>
  <Suspense>
    <Text3D ref="textRef" text="Shader" :position="[-2, 2, 0]" :font="fontPath" :size="0.15" />
  </Suspense>
  ...
  <!-- NO SHADER -->
  <Suspense>
    <Text3D ref="text1Ref" text="No Shader" :position="[2, 2, 0]" :font="fontPath" :size="0.15" />
  </Suspense>
  <TresMesh :geometry="geometry" :position-x="2">
    <TresMeshLambertMaterial />
  </TresMesh>
  <TresSprite v-if="!isLoading" :geometry="geometry" :position-x="2" :scale="options.scale">
