...
<template>
  ...
  <TresMesh :rotation-x="Math.PI * -0.5">
    <TresPlaneGeometry :args="[3, 3, 100, 100]" />
    <TresMeshStandardMaterial v-if="textures[0] && textures[1]" :displacementMap="textures[0]" :map="textures[1]" :normalMap="textures[2]" :aoMap="textures[3]" />
  </TresMesh>
