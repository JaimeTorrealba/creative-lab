...
import vertexShader from './shaders/texture-particles-cursor/vertex.glsl';
import fragmentShader from './shaders/texture-particles-cursor/fragment.glsl';
...
const displacementMesh = shallowRef()
