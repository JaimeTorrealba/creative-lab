...
function addEventListeners() {
  useEventListener(controlsRef.value, 'dragstart', () => emit('dragstart', controlsRef.value))
  useEventListener(controlsRef.value, 'drag', () => emit('drag', controlsRef.value))
  useEventListener(controlsRef.value, 'dragend', () => emit('dragend', controlsRef.value))
  useEventListener(controlsRef.value, 'hoveron', () => emit('hoveron', controlsRef.value))
  useEventListener(controlsRef.value, 'hoveroff', () => emit('hoveroff', controlsRef.value))
}
onUnmounted(() => {
  if (controlsRef.value) {
